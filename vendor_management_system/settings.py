...
SECRET_KEY = 'django-insecure-p1cmpdna)$&5^)1deb$hsxg9^p&)o5j&w&q9@xp=-c9ohv8wi8'
...
CORS_ALLOW_ALL_ORIGINS = True  # True for development, consider specific origins for production
